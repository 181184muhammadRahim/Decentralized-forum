    ...
    <>
      ...
      <div className="hero text-center my-3">
        <div className="cardValue mx-5 py-4 my-5">
          ...
          <div className="col">
            <input
              className="py-2 inputArea mr-4 mt-4"
              type="text"
              value={message}
              onChange={(e) => setMessage(e.target.value)}
            ></input>
            <button className="btn btn-info" onClick={post}>
              Add Post
            </button>
          </div>
        </div>
